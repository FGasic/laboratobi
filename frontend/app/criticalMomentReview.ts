...
export function buildReviewedCriticalMoment(
  ...
  return {
    ...
    engine_best_move: review?.engine_best_move ?? null,
    engine_principal_variation: review?.engine_principal_variation ?? [],
    fen_before: review?.fen_before ?? null,
    engine_line_eval_cp: review?.engine_line_eval_cp ?? null,
    engine_line_mate: review?.engine_line_mate ?? null,
    played_move_eval_cp: review?.played_move_eval_cp ?? null,
    played_move_mate: review?.played_move_mate ?? null,
    engine_name: review?.engine_name ?? null,
    analysis_depth: review?.depth_used ?? null,
  };
}
